...
BEGIN
  ...
  -- ─── Build base universe (temp table) ───
  ...
  -- ─── Detect resgatados ───
  -- A resgatado is someone who had a visit in [p_inicio..p_fim] AND
  -- before that visit was absent >= p_resgate_dias_minimos
  ...
  -- Actually compute resgatados properly using a lateral
  ...
  -- ─── Por barbeiro (MULTI attribution) ───
  ...
  -- ─── Lista top 50 perdidos/risco/resgatados ───
  v_lista := COALESCE((
...
BEGIN
  ...
  -- Build base (same logic as churn_v1)
