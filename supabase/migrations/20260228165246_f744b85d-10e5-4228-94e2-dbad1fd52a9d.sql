...
-- Drop and recreate rpc_clientes_barbeiro_detalhe with expanded freq_dist
DROP FUNCTION IF EXISTS public.rpc_clientes_barbeiro_detalhe(text, text, text, text);
