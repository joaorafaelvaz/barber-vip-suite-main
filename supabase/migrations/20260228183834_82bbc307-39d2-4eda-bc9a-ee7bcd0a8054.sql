...
BEGIN
  ...
  -- Fixed: perdidos_barbearia = PERDIDO clients whose last visit globally is also old (truly left)
  -- perdidos_para_outro = PERDIDO clients who visited another barber after their last visit with this one
  perdidos AS (
    SELECT
