...
export function TabSeguranca() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-lg font-semibold text-foreground">{t('nav.seguranca')}</h2>
        <p className="text-sm text-muted-foreground">Configurações de segurança da organização</p>
      </div>
      ...
      <Card className="bg-card/50 backdrop-blur-sm border-border/50">
        <CardHeader className="pb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-base">Política de Sessão</CardTitle>
              <CardDescription className="text-xs">
