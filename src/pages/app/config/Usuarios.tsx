...
export default function Usuarios() {
  ...
  return (
    <AccessGuard permission="canManageUsers">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Select value={roleFilter || '__all__'} onValueChange={(value) => { setRoleFilter(value === '__all__' ? '' : value); setPage(1); }}>
            ...
            <SelectContent>
              ...
              <SelectItem value="master">{t('users.roles.master')}</SelectItem>
              <SelectItem value="franquia_admin">{t('users.roles.franquia_admin')}</SelectItem>
              <SelectItem value="unidade_gerente">{t('users.roles.unidade_gerente')}</SelectItem>
              <SelectItem value="colaborador">{t('users.roles.colaborador')}</SelectItem>
            </SelectContent>
          </Select>
